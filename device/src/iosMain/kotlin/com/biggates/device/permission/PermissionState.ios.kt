...
import com.biggates.device.permission.location.requestLocationAlways
import com.biggates.device.permission.location.requestLocationWhenInUse
import com.biggates.device.permission.notification.checkNotificationsGranted
import com.biggates.device.permission.notification.requestNotifications
...
class IosPermissionController(
    ...
    private suspend fun isNotificationsNotDetermined(): Boolean {
        val settings = kotlinx.coroutines.suspendCancellableCoroutine { cont ->
